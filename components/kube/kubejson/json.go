...
// Based on https://github.com/protocolbuffers/protobuf-go/blob/master/encoding/protojson/encode.go
...
func (e encoder) marshalMessage(m protoreflect.Message, typeURL string) error {
	...
	if obj, ok := m.Interface().(kube.Object); ok {
		...
		if err := e.WriteString(kindInfo.APIVersion()); err != nil {
			return err
		}
		if err := e.WriteName("kind"); err != nil {
			return err
		}
		if err := e.WriteString(kindInfo.Kind); err != nil {
			return err
		}
	}
...
func (e encoder) marshalSingular(val protoreflect.Value, fd protoreflect.FieldDescriptor) error {
	...
	case protoreflect.StringKind:
		if e.WriteString(val.String()) != nil {
			...
			return fmt.Errorf("field %q is not valid UTF8", fd.FullName())
		}
